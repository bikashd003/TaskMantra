            ...
            <div className="flex bg-slate-100/80 rounded-xl overflow-hidden p-1 shadow-inner">
              <Button
                ...
                className={cn(
                  ...
                  view === 'month' ? "bg-white text-blue-600 shadow-sm" : "text-slate-600 hover:text-blue-500"
                )}
              ...
              <Button
                ...
                className={cn(
                  "rounded-lg transition-all duration-200",
                  view === 'week' ? "bg-white text-blue-600 shadow-sm" : "text-slate-600 hover:text-blue-500"
                )}
              ...
              <Button
                ...
                className={cn(
                  "rounded-lg transition-all duration-200",
                  view === 'day' ? "bg-white text-blue-600 shadow-sm" : "text-slate-600 hover:text-blue-500"
                )}
