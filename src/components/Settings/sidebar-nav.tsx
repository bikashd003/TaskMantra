...
export function SidebarNav() {
    ...
    const NavContent = () => (
        <Card className="min-h-[calc(100vh-140px)] rounded-lg shadow-md">
            <CardContent className="p-6 space-y-8">
                <div>
                    <CardTitle className="mb-4 text-sm font-bold tracking-wider text-gray-700 uppercase">Account</CardTitle>
                ...
                <div>
                    <CardTitle className="mb-4 text-sm font-bold tracking-wider text-gray-700 uppercase">Workspace</CardTitle>
                    <div className="space-y-2">
                ...
                <div>
                    <CardTitle className="mb-4 text-sm font-bold tracking-wider text-gray-700 uppercase">Billing & Admin</CardTitle>
                    <div className="space-y-2">
        ...
        <>
            ...
            <Sheet open={open} onOpenChange={setOpen}>
                <SheetTrigger asChild className="md:hidden">
                    <Button variant="ghost" size="icon" className="px-0 text-base hover:bg-transparent hover:text-primary focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0">
